...
### Futuristic Cyberpunk Spy Fashion Portrait in Cinematic Chase Scene
**Prompt:**
```
Cinematic candid portrait of a glamorous high fashion model of any race who is a spy wearing futuristic high fashion spy clothes, she is on a dangerous mission in the cosmopolitan part of a sci-fi cyberpunk city of the future at night, she is being chased, wet streets, reflections, danger, Foggy, hazy atmosphere, volumetric light rays. Hyper realistic fine art portraiture, painterly color tones, high detail skin realism, visible pores, raw unretouched skin texture. Ethereal sci fi fashion aesthetic, dreamy cinematic lighting, shallow depth of field, organic motion, storytelling portrait, modern romantic analog film mood. Hasselblad macro 8K photorealistic editorial fine art portrait. **Negative prompt:** no shadows, flat light, airbrushed skin, no pores, studio lighting, painted, illustration, CGI, plastic skin, wet skin, bright white background
```
**Source:** [MJ alpha](https://alpha.midjourney.com)

### Historical Sogdian Silk Road Caravan Merchant Portrait
**Prompt:**
```
Medium portrait of a Sogdian caravan merchant standing in open steppe, neutral daytime background, 7th century Silk Road trader, Central Asian Sogdian ethnicity, lean weathered face, trimmed beard, intelligent cautious expression, traditional Sogdian merchant robes layered with practical travel coat, patterned woven caftan, leather belt, soft boots, headwrap or modest merchant cap, practical travel satchel, small trade pouches, modest curved blade at the waist for protection, not a warrior weapon, no armor, no military costume, natural upright pose like a character portrait, wind moving garments, historically accurate Silk Road merchant appearance, muted earth tones with subdued textile colors, cinematic color grading, ultra realistic, 85mm lens, shallow depth of field, medium plan, documentary-historical film still, high detail.
```
**Source:** [MJ alpha](https://alpha.midjourney.com)

### Single-Softbox Dramatic Shadow Portrait Lighting Setup
**Prompt:**
```
Portrait lit from a single softbox positioned 45 degrees to the left, creating a strong shadow across the right side of the face, against a dark gray background
```
**Source:** [MindStudio](https://www.mindstudio.ai/blog/how-to-get-best-results-midjourney-v8)

### Butterfly Lighting Commercial Studio Portrait of Professional Woman
**Prompt:**
```
Professional woman in her 30s, confident subtle smile, shoulders turned slightly, butterfly lighting with soft fill, pure white seamless background, shot on Phase One with 110mm f/2.8, clean commercial aesthetic --ar 4:5 --s 50 --v 7
```
...
**Prompt:**
```
professional headshot of a woman in her 30s, short dark hair, wearing a navy blazer, smiling confidently. Soft studio lighting, light gray background, shallow depth of field, DSLR photography style
```
**Source:** [MindStudio](https://www.mindstudio.ai/blog/gpt-image-2-use-cases-2)

### Hyper-Realistic Elderly Hands Garlic Peeling Documentary Portrait
**Prompt:**
```
...
### Cinematic Woman Portrait with Monumental Abstract Mural Background
**Prompt:**
```
...
Negative: blurry, overexposed, cartoonish, distorted anatomy, extra limbs, poorly drawn hands, merged faces, unrealistic colors, watermark, text. ar. 9 :16
```
**Source:** [@Naiknelofar788](https://x.com/Naiknelofar788)

### Cinematic Silhouette Figure in Orange-Red Gradient Minimal Scene
**Prompt:**
```
...
```
**Source:** [PixVerse](https://pixverse.ai/en/blog/gpt-image-2-review-and-prompt-guide)

### Ultra-Realistic Studio Portrait of Woman with Navy Blazer in studio
**Prompt:**
```
