...
### Vintage Cottagecore Washing Machine Illustration
**Prompt:**
```
illustration of a washing machine in the style of watercolor, vintage poster design, detailed background elements, cottagecore aesthetic, white and blue tones, high resolution, charming illustrations, cartoonish cuteness, wooden shelves with jars on them. Hyperrealistic oil painting --s 50 --v 8
```
**Source:** [Legnext](https://legnext.ai)

### Children's Book Goats in Chinese Mythology Costumes
**Prompt:**
```
An illustration from a children's book depicting three goats are dressing up as gods from Chinese legends. Presented in the style of Eric Carle with a combination of watercolor and oil painting, full-body perspective, white background, bright colors, and clean lines.
```
**Source:** [MJ alpha](https://alpha.midjourney.com)

### Whimsical Vintage Sardine Tin Poster Design
**Prompt:**
```
whimsical wall art poster, flat-design illustration, a stack of vintage cobalt blue sardine tins, doodle hand-drawn white outlines of tiny people trying to lift one lid with ropes, cream beige paper background, bold fuchsia pink typography at top reading "VINTAGE CATCH", emerald green hand-drawn border, playful retro aesthetics
```
**Source:** [MJ alpha](https://alpha.midjourney.com)

### 2D flat illustration poster
**Prompt:**
```
Bible Project infographic poster, flat 2D illustration, vertical composition split into two horizontal bands, upper band shows the Courts of Heaven with throne scrolls lampstands and glory rays no human figures, lower band shows the Gates of Earth with city walls and a gateway arch with faceless pictogram figures standing at the gates as guardians, Ark of the Covenant centered on the dividing line bridging both realms, hand-drawn linework, bright off-white background, saturated palette of mustard teal coral navy and gold, Hebrew letterform motifs, modern sacred diagram, as above so below
```
**Source:** [MJ alpha](https://alpha.midjourney.com)
...
**Prompt:**
```
Birthday cake with a single candle
```
**Source:** [MJ alpha](https://alpha.midjourney.com/jobs/12d7f5e5-3ec1-476b-987b-910cf43ddb7f)

### Cyberpunk warrior silhouette with neon katana
**Prompt:**
```
Cyberpunk warrior silhouette with neon katana, glowing tech armor details, electric blue and magenta accents, dramatic rim lighting, bold graphic illustration, isolated on black background, commercial t-shirt print design
```
**Source:** [MJ alpha](https://alpha.midjourney.com/jobs/3338994c-4864-4f67-ad76-7ed0de7bbe3e)

### Full body shot of a dystopian 8 year old boy
**Prompt:**
```
full body shot of a 8 year old cute chubby boy wearing a simple dystopian fit leather wear and leather hat, on white background
```
**Source:** [MJ alpha](https://alpha.midjourney.com/jobs/2a6c1cef-84f1-4064-87bc-4caf7468b59a)

### Vertical floating bubbles
**Prompt:**
```
A vertical strip of small floating bubbles and particles, flat 2D, white and light blue, various sizes, scattered naturally, transparent background, tall narrow format for layering.
```
**Source:** [MJ alpha](https://alpha.midjourney.com/jobs/80ebff8e-ba6a-4e98-940f-5f99ca6597d7)

### Vertical floating bubbles
**Prompt:**
```
a brush and hillside painting of various random curved shapes and humanoid asymmetric geometrical figures and shapes with random weird object and pet forms, the style is naïf geometrical between absurd and surreal, the colors in the palette between ochre, and dark green with touch of pink, blue and red, the background is predominantly white but with light wave patterns, no single eyes
```
...
**Prompt:**
```
Create a children's book illustration introducing a main character. A young forest helper wearing a green hooded tunic, soft brown boots, and a small belt pouch. Kind expression, gentle eyes, warm but brave personality. Hand-painted watercolor look, earthy colors, soft outlines, whimsical but grounded. No text. No watermark.
```
**Source:** [Fal AI](https://fal.ai/learn/tools/prompting-gpt-image-2)

### 100 Tech Progress Topics Grid Illustration
**Prompt:**
```
...
```
**Source:** [@liyue_ai](https://x.com/liyue_ai/status/2045875219307655337)
...
```
**Source:** [@liyue_ai](https://x.com/liyue_ai/status/2045368305079447853)
...
[CHARACTER]
young female dancer, athletic build, ponytail hairstyle, crop top and baggy pants, sneakers, same character in all panels
