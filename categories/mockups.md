...
### Minimal Boho Smartphone Product Shot on Rattan Tray
**Prompt:**
```
...
### Glossy Heart-Shaped Pink Gummy Bears Candy Render
**Prompt:**
```
heart shaped pink gummy bears candy, jelly texture, translucent glossy surface, pastel pink, kawaii aesthetic, white background, 3/4 view, soft shadows, product shoot, 4k
```
**Source:** [MJ alpha](https://alpha.midjourney.com)
...
### Luxury Watch Product Photography on Dark Marble with Water Droplet
**Prompt:**
```
...
**Prompt:**
```
A minimalist product advertisement with a fried chicken bucket placed on a clean white podium.

Background: soft gradient (light cream to white), clean studio.

Lighting: soft diffused, premium Apple-style.

Typography (center): “PURE CRUNCH”
...
**Prompt:**
```
A professional product packaging mockup for an organic skincare brand called “LUMEA”, displayed on a soft beige studio surface. The set includes glass bottles, cream jars, and cardboard boxes with minimalist typography and botanical illustrations. Natural shadows, soft diffused lighting, and neutral tones emphasize sustainability and elegance. The packaging design is clean, modern, and eco-luxury oriented, with subtle embossed textures visible on labels.
```
**Source:** [seaart](https://www.seaart.ai/blog/gpt-image-2-prompts)

### Beer cans packaging mockup
**Prompt:**
```
A photoreal product packaging mockup of three 330ml craft beer cans standing in a row on a wet concrete bar top, dramatic side-lit studio lighting, aspect ratio 16:9. Each slim aluminum can shares a brand block "NORTHWAVE BREWING CO." across the top, with distinct illustrated labels: left can — turquoise wave artwork "HAZY IPA · 6.2% ABV", center can — coral sunset "PASSIONFRUIT SOUR · 4.8% ABV", right can — deep navy with lightning "DOUBLE OATMEAL STOUT · 8.1% ABV". Real condensation droplets on the brushed aluminum, subtle reflections of warm bar lights. Crisp printed type, tactile ink feel. Premium craft-brand commercial photography style. No real-brand logos beyond the fictional one, no watermark.
```
**Source:** [seaart](https://www.seaart.ai/blog/gpt-image-2-prompts)
